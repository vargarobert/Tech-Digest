...
//        _circle.fillColor = [UIColor grayColor].CGColor; //[UIColor colorWithRed:0.173 green:0.243 blue:0.314 alpha:1].CGColor; /*#2c3e50*/
//        _circle.opacity = 0.7f;
        NSArray *colors = [NSArray arrayWithObjects:[UIColor colorWithHexString:@"DE5149"],  nil];
//        NSMutableArray * colors = [[NSMutableArray alloc]init];
//        NSDictionary *categories = [CategoryColors getAllCategories];
//        for (id key in categories) {
//            UIColor *color = categories[key];
//            [colors addObject:color];
//        }
        _circle.fillColor = [UIColor colorWithGradientStyle:UIGradientStyleRadial
                                                                        withFrame:self.frame                                                               andColors:colors].CGColor;
